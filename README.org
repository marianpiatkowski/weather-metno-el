...
The API of the Norwegian national meterological institute has changed. The
current version is now 2.0. Some example links are:
https://api.met.no/weatherapi/locationforecast/2.0/classic?lat=49.42&lon=8.67
https://api.met.no/weatherapi/sunrise/2.0/?lat=49.42&lon=8.67&date=2020-08-22&offset=+02:00

Example link to download weather icons:
curl -O https://raw.githubusercontent.com/nrkno/yr-weather-symbols/master/dist/png/30/01d.png
The corresponding Git repository is at:
https://github.com/nrkno/yr-weather-symbols.git
